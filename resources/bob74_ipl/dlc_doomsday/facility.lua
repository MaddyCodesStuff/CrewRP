...
DoomsdayFacility = {
    ...
    Sleeping    = {
        ...
        Clear   = function(refresh)
            SetIplPropState(DoomsdayFacility.interiorId,
                            { DoomsdayFacility.Sleeping.none, DoomsdayFacility.Sleeping.utility, DoomsdayFacility.Sleeping.prestige, DoomsdayFacility.Sleeping.premier },
                            false, refresh)
        end
    },
    Security    = {
        ...
        Clear = function(refresh)
            SetIplPropState(DoomsdayFacility.interiorId,
                            { DoomsdayFacility.Security.off, DoomsdayFacility.Security.on }, false, refresh)
        end
    },
    Cannon      = {
        ...
        Clear = function(refresh)
            SetIplPropState(DoomsdayFacility.interiorId, { DoomsdayFacility.Cannon.off, DoomsdayFacility.Cannon.on },
                            false, refresh)
        end
    },
    Details     = {
    ...
    LoadDefault = function()
        ...
        DoomsdayFacility.Details.Enable({ DoomsdayFacility.Details.Clutter.A, DoomsdayFacility.Details.Clutter.B },
                                        true)
