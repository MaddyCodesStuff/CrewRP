...
SmugglerHangar = {
    ...
    Floor       = {
        ...
        Decals = {
            ...
            Clear  = function(refresh)
                SetIplPropState(SmugglerHangar.interiorId,
                                { SmugglerHangar.Floor.Decals.decal1, SmugglerHangar.Floor.Decals.decal2, SmugglerHangar.Floor.Decals.decal3,
                                  ...
                                  SmugglerHangar.Floor.Decals.decal8, SmugglerHangar.Floor.Decals.decal9 }, false,
                                refresh)
            end
        }
    },
    ...
    Bedroom     = {
        ...
        Blinds = {
            ...
            Clear = function(refresh)
                SetIplPropState(SmugglerHangar.interiorId,
                                { SmugglerHangar.Bedroom.Blinds.opened, SmugglerHangar.Bedroom.Blinds.closed }, false,
                                refresh)
            end
        }
    },
    Lighting    = {
        ...
        Ceiling    = {
            ...
            Clear = function(refresh)
                SetIplPropState(SmugglerHangar.interiorId,
                                { SmugglerHangar.Lighting.Ceiling.yellow, SmugglerHangar.Lighting.Ceiling.blue, SmugglerHangar.Lighting.Ceiling.white },
                                false, refresh)
            end
        },
        Walls      = {
            ...
            Clear        = function(refresh)
                SetIplPropState(SmugglerHangar.interiorId,
                                { SmugglerHangar.Lighting.Walls.neutral, SmugglerHangar.Lighting.Walls.blue, SmugglerHangar.Lighting.Walls.orange,
