...
ImportCEOGarage1 = {
    Part        = {
        ...
        Clear   = function()
            EnableIpl({ ImportCEOGarage1.Part.Garage1.ipl, ImportCEOGarage1.Part.Garage2.ipl, ImportCEOGarage1.Part.Garage3.ipl },
                      false)
        end,
    },
    Style       = {
        ...
        Clear    = function(part)
            SetIplPropState(part.interiorId,
                            { ImportCEOGarage1.Style.concrete, ImportCEOGarage1.Style.plain, ImportCEOGarage1.Style.marble, ImportCEOGarage1.Style.wooden },
                            false, true)
        end
    },
    Numbering   = {
