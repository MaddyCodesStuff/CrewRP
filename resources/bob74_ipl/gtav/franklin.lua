    ...
    Style       = {
        ...
        Clear = function(refresh)
            SetIplPropState(Franklin.interiorId,
                            { Franklin.Style.settled, Franklin.Style.unpacking, Franklin.Style.cardboxes }, false,
                            refresh)
        end
    },
    GlassDoor   = {
        ...
        Clear  = function(refresh)
            SetIplPropState(Franklin.interiorId, { Franklin.GlassDoor.opened, Franklin.GlassDoor.closed }, false,
                            refresh)
        end
    },
    Details     = {
