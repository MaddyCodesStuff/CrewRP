...
BikerClubhouse2 = {
    ...
    Walls       = {
        ...
        Clear = function(refresh)
            SetIplPropState(BikerClubhouse2.interiorId, { BikerClubhouse2.Walls.brick, BikerClubhouse2.Walls.plain },
                            false, refresh)
        end
    },
    LowerWalls  = {
    ...
    Furnitures  = {
        ...
        Clear = function(refresh)
            SetIplPropState(BikerClubhouse2.interiorId, { BikerClubhouse2.Furnitures.A, BikerClubhouse2.Furnitures.B },
                            false, refresh)
        end
    },
    Decoration  = {
        ...
        Clear = function(refresh)
            SetIplPropState(BikerClubhouse2.interiorId, { BikerClubhouse2.Decoration.A, BikerClubhouse2.Decoration.B },
                            false, refresh)
        end
    },
    Mural       = {
        ...
        Clear     = function(refresh)
            SetIplPropState(BikerClubhouse2.interiorId,
                            { BikerClubhouse2.Mural.death1, BikerClubhouse2.Mural.cityColor1, BikerClubhouse2.Mural.death2, BikerClubhouse2.Mural.cityColor2,
                              BikerClubhouse2.Mural.graffitis, BikerClubhouse2.Mural.cityColor3, BikerClubhouse2.Mural.cityColor4, BikerClubhouse2.Mural.cityBlack, BikerClubhouse2.Mural.death3 },
                            false, refresh)
        end
    },
    GunLocker   = {
        ...
        Clear = function(refresh)
            SetIplPropState(BikerClubhouse2.interiorId, { BikerClubhouse2.GunLocker.on, BikerClubhouse2.GunLocker.off },
                            false, refresh)
        end
    },
    ModBooth    = {
        ...
        Clear = function(refresh)
            SetIplPropState(BikerClubhouse2.interiorId, { BikerClubhouse2.ModBooth.on, BikerClubhouse2.ModBooth.off },
                            false, refresh)
        end
    },
    Meth        = {
