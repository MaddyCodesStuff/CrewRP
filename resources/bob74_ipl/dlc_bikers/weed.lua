...
BikerWeedFarm = {
    ...
    Style       = {
        ...
        Clear = function(refresh)
            SetIplPropState(BikerWeedFarm.interiorId, { BikerWeedFarm.Style.basic, BikerWeedFarm.Style.upgrade }, false,
                            refresh)
        end
    },
    Security    = {
        ...
        Clear = function(refresh)
            SetIplPropState(BikerWeedFarm.interiorId, { BikerWeedFarm.Security.basic, BikerWeedFarm.Security.upgrade },
                            false, refresh)
        end
    },
    Plant1      = {
        ...
        Light = {
            ...
            Clear = function(refresh)
                SetIplPropState(BikerWeedFarm.interiorId,
                                { BikerWeedFarm.Plant1.Light.basic, BikerWeedFarm.Plant1.Light.upgrade }, false,
                                refresh)
            end
        },
        Hose  = {
    ...
    Plant2      = {
        ...
        Light = {
            ...
            Clear = function(refresh)
                SetIplPropState(BikerWeedFarm.interiorId,
                                { BikerWeedFarm.Plant2.Light.basic, BikerWeedFarm.Plant2.Light.upgrade }, false,
                                refresh)
            end
        },
        Hose  = {
    ...
    Plant3      = {
        ...
        Light = {
            ...
            Clear = function(refresh)
                SetIplPropState(BikerWeedFarm.interiorId,
                                { BikerWeedFarm.Plant3.Light.basic, BikerWeedFarm.Plant3.Light.upgrade }, false,
                                refresh)
            end
        },
        Hose  = {
    ...
    Plant4      = {
        ...
        Light = {
            ...
            Clear = function(refresh)
                SetIplPropState(BikerWeedFarm.interiorId,
                                { BikerWeedFarm.Plant4.Light.basic, BikerWeedFarm.Plant4.Light.upgrade }, false,
                                refresh)
            end
        },
        Hose  = {
    ...
    Plant5      = {
        ...
        Light = {
            ...
            Clear = function(refresh)
                SetIplPropState(BikerWeedFarm.interiorId,
                                { BikerWeedFarm.Plant5.Light.basic, BikerWeedFarm.Plant5.Light.upgrade }, false,
                                refresh)
            end
        },
        Hose  = {
    ...
    Plant6      = {
        ...
        Light = {
            ...
            Clear = function(refresh)
                SetIplPropState(BikerWeedFarm.interiorId,
                                { BikerWeedFarm.Plant6.Light.basic, BikerWeedFarm.Plant6.Light.upgrade }, false,
                                refresh)
            end
        },
        Hose  = {
    ...
    Plant7      = {
        ...
        Light = {
            ...
            Clear = function(refresh)
                SetIplPropState(BikerWeedFarm.interiorId,
                                { BikerWeedFarm.Plant7.Light.basic, BikerWeedFarm.Plant7.Light.upgrade }, false,
                                refresh)
            end
        },
        Hose  = {
    ...
    Plant8      = {
        ...
        Light = {
            ...
            Clear = function(refresh)
                SetIplPropState(BikerWeedFarm.interiorId,
                                { BikerWeedFarm.Plant8.Light.basic, BikerWeedFarm.Plant8.Light.upgrade }, false,
                                refresh)
            end
        },
        Hose  = {
    ...
    Plant9      = {
        ...
        Light = {
            ...
            Clear = function(refresh)
                SetIplPropState(BikerWeedFarm.interiorId,
                                { BikerWeedFarm.Plant9.Light.basic, BikerWeedFarm.Plant9.Light.upgrade }, false,
                                refresh)
            end
        },
        Hose  = {
    ...
    LoadDefault = function()
        ...
        BikerWeedFarm.Details.Enable({ BikerWeedFarm.Details.production, BikerWeedFarm.Details.chairs, BikerWeedFarm.Details.drying },
                                     true)
