...
BikerClubhouse1 = {
    ...
    Walls       = {
        ...
        Clear = function(refresh)
            SetIplPropState(BikerClubhouse1.interiorId, { BikerClubhouse1.Walls.brick, BikerClubhouse1.Walls.plain },
                            false, refresh)
        end
    },
    Furnitures  = {
        ...
        Clear = function(refresh)
            SetIplPropState(BikerClubhouse1.interiorId, { BikerClubhouse1.Furnitures.A, BikerClubhouse1.Furnitures.B },
                            false, refresh)
        end
    },
    Decoration  = {
        ...
        Clear = function(refresh)
            SetIplPropState(BikerClubhouse1.interiorId, { BikerClubhouse1.Decoration.A, BikerClubhouse1.Decoration.B },
                            false, refresh)
        end
    },
    Mural       = {
        ...
        Clear   = function(refresh)
            SetIplPropState(BikerClubhouse1.interiorId,
                            { BikerClubhouse1.Mural.rideFree, BikerClubhouse1.Mural.mods, BikerClubhouse1.Mural.brave, BikerClubhouse1.Mural.fist,
                              BikerClubhouse1.Mural.forest, BikerClubhouse1.Mural.mods2, BikerClubhouse1.Mural.rideForever, BikerClubhouse1.Mural.heart, BikerClubhouse1.Mural.route68 },
                            false, refresh)
        end
    },
    GunLocker   = {
        ...
        Clear = function(refresh)
            SetIplPropState(BikerClubhouse1.interiorId, { BikerClubhouse1.GunLocker.on, BikerClubhouse1.GunLocker.off },
                            false, refresh)
        end
    },
    ModBooth    = {
        ...
        Clear = function(refresh)
            SetIplPropState(BikerClubhouse1.interiorId, { BikerClubhouse1.ModBooth.on, BikerClubhouse1.ModBooth.off },
                            false, refresh)
        end
    },
    Meth        = {
