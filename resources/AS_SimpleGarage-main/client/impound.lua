...
Citizen.CreateThread(function()
	...
	AddTextComponentString("Impound Storage")
	...
	local blip4 = AddBlipForCoord(Config.PlaneImpound.RetrieveLocation1.x, Config.PlaneImpound.RetrieveLocation1.y, Config.PlaneImpound.RetrieveLocation1.z)
	SetBlipScale(blip4, 0.7)
	SetBlipDisplay(blip4, 4)
	SetBlipSprite(blip4, 372)
	SetBlipColour(blip4, 5)
	SetBlipAsShortRange(blip4, true)
	BeginTextCommandSetBlipName("STRING")
	AddTextComponentString("Plane Impound Storage")
	EndTextCommandSetBlipName(blip4)

	local blip5 = AddBlipForCoord(Config.PlaneImpound.RetrieveLocation2.x, Config.PlaneImpound.RetrieveLocation2.y, Config.PlaneImpound.RetrieveLocation2.z)
	SetBlipScale(blip5, 0.7)
	SetBlipDisplay(blip5, 4)
	SetBlipSprite(blip5, 372)
	...
	local blip6 = AddBlipForCoord(Config.BoatImpound.RetrieveLocation1.x, Config.BoatImpound.RetrieveLocation1.y, Config.BoatImpound.RetrieveLocation1.z)
	SetBlipScale(blip6, 0.7)
	SetBlipDisplay(blip6, 4)
	SetBlipSprite(blip6, 371)
	SetBlipColour(blip6, 5)
	SetBlipAsShortRange(blip6, true)
	BeginTextCommandSetBlipName("STRING")
	AddTextComponentString("Boat Impound Storage")
	EndTextCommandSetBlipName(blip6)

	local blip7 = AddBlipForCoord(Config.BoatImpound.RetrieveLocation2.x, Config.BoatImpound.RetrieveLocation2.y, Config.BoatImpound.RetrieveLocation2.z)
	SetBlipScale(blip7, 0.7)
	SetBlipDisplay(blip7, 4)
	SetBlipSprite(blip7, 371)
	...
	local blip8 = AddBlipForCoord(Config.BoatImpound.RetrieveLocation3.x, Config.BoatImpound.RetrieveLocation3.y, Config.BoatImpound.RetrieveLocation3.z)
	SetBlipScale(blip8, 0.7)
	SetBlipDisplay(blip8, 4)
	SetBlipSprite(blip8, 371)
