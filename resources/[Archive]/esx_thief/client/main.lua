                    ...
                    if data2.current.action == 'steal' then
                        ...
                        if itemType == 'item_standard' then
                            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'steal_inventory_item_standard', {
                                ...
                                TriggerServerEvent('esx_thief:stealPlayerItem', GetPlayerServerId(target), itemType,
                                                   itemName, quantity)
...
Citizen.CreateThread(function()
    while true do
        ...
        if IsControlJustReleased(0, Keys['E']) and IsPedArmed(ped,  7) and not IsEntityDead(ped) and IsPedOnFoot(ped) then
