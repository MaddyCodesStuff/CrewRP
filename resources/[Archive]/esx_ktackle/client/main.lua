...
AddEventHandler('esx_kekke_tackle:getTackled', function(target)
    ...
    AttachEntityToEntity(GetPlayerPed(-1), targetPed, 11816, 0.25, 0.5, 0.0, 0.5, 0.5, 180.0, false, false, false,
                         false, 2, false)
...
Citizen.CreateThread(function()
    while true do
        ...
        if IsControlPressed(0, Keys['LEFTSHIFT']) and IsControlPressed(0,
                                                                       Keys['G']) and not isTackling and GetGameTimer() - lastTackleTime > 10 * 1000 and PlayerData.job.name == PoliceJob then
            Citizen.Wait(10)
