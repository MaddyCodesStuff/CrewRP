...
Citizen.CreateThread(function()
    while true do
        ...
        if POS_actual > 0 and (Vdist(playerPos.x, playerPos.y, playerPos.z, INTERIORS[POS_actual].x,
                                     INTERIORS[POS_actual].y, INTERIORS[POS_actual].z) > 2.0) then
        ...
        if gui_interiors.opened then
            ...
            gui_interiors_drawTxt(gui_interiors.title, 1, 1, gui_interiors.menu.x, gui_interiors.menu.y, 1.0, 255, 255,
                                  255, 255)
            gui_interiors_drawMenuTitle(menu.title, gui_interiors.menu.x, gui_interiors.menu.y + 0.08)
            gui_interiors_drawTxt(gui_interiors.selectedbutton .. "/" .. tablelength(menu.buttons), 0, 0,
                                  gui_interiors.menu.x + gui_interiors.menu.width / 2 - 0.0385,
                                  gui_interiors.menu.y + 0.067, 0.4, 255, 255, 255, 255)
