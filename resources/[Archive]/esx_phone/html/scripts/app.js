(function () {
  ...
  let ContactTpl = '<div class="contact {{online}}">' + '<div class="sender-info">' + '<div class="center">' +
  ...
  let MessageTpl = '<div class="message">' + '<div class="sender-info">' + '<div class="center">' +
                   '<span class="sender">{{sender}}</span><br/><span class="phone-number">#{{phoneNumber}}</span>' +
                   '</div>' + '</div>' + '<div class="body">{{message}}</div>' +
  ...
  let renderSpecialContacts = function () {
    ...
    $('#phone .menu .home').html('<li class="phone-icon" id="phone-icon-rep">Repertoire</li>' +
