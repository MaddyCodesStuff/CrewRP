...
mumbleConfig = {
    ...
    radioVolume = 0.65, -- Volume of player speaking on radio
    callVolume = 0.4, -- Volume of player speaking on a phone call
	speakingVolume = 0.8, -- Volume of player speaking (adjusted for range)
	...
	volume2dAudioInVehicles = 0.3, -- Volume of passenger voices in vehicle when using 2d audio
