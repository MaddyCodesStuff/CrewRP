Locales['en'] = {
    ['route_assigned']                     = 'You have been assigned %s.',
    ['drive_to_first_marker']              = 'Get in bus and drive to first stop at %s.',
    ['drive_to_next_marker']               = 'Continue to next stop at %s.',
    ...
    ['start_route']                        = 'press ~INPUT_PICKUP~ to start %s.',
    ['passengers_loaded']                  = '%d passengers paid for this stop. Collected $%d.',
    ['return_to_terminal']                 = 'Route is finished. Return to the terminal.',
    ['stop_bus']                           = 'Stop bus to return it and get paid.',
    ['abort_route_help']                   = 'press ~INPUT_PICKUP~ to abort route. Will cost $%d.',
    ...
    ['abort_route']                        = 'Abort %s',
    ['airport_route']                      = 'Bus Terminal',
    ['scenic_route']                       = 'Bus Terminal',
    ['metro_route']                        = 'Bus Terminal',
    ['metro_yellow']                       = 'Bus Terminal',
    ['metro_blue']                         = 'Bus Terminal',
    ['metro_red']                          = 'Bus Terminal',
    ['metro_purple']                       = 'Bus Terminal',
    ['metro_orange']                       = 'Bus Terminal',
    ['metro_black']                        = 'Bus Terminal',
    ['terminal']                           = 'Terminal',
