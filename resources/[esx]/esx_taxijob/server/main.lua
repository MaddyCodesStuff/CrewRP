...
AddEventHandler('esx_taxijob:success', function(duration)
  ...
  if duration >= 120000 then
    total = total * 2
  elseif duration >= 60000 and duration <= 119999 then
    total = total + 3
  elseif duration >= 30000 and duration <= 59999 then
    total = total + 2
  elseif duration >= 10000 and duration <= 29999 then
    total = total + 1
  end
