...
TriggerEvent('esx_phone:registerNumber', 'News', 'Journalist', true, true)
TriggerEvent('esx_society:registerSociety', 'journalist', 'journalist', 'society_journalist', 'society_journalist', 'society_journalist', {type = 'private'})
