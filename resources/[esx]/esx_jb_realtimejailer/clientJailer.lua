...
function jailing(Station, JailTime)
    ...
    if DoesEntityExist(PlayerPed) then
        ...
        Citizen.CreateThread(function()
            ...
            while JailTime > 0 and not IsPlayerUnjailed do
                ...
                if JailTime % 10 == 0 then
                    if JailTime % 30 == 0 then
                        TriggerEvent('chatMessage', 'SYSTEM', { 0, 0, 0 },
                                     math.floor(jaildays) .. " jours, " .. math.floor(jailhours) .. " heures," .. math.floor(jailminutes) .. " minutes, " .. math.floor(jailseconds) .. " secondes avant d'être libéré.")
                    end
                end
                Citizen.Wait(1000)
            ...
            TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 },
                               GetPlayerName(PlayerId()) .. " a été libéré de la prison.")
