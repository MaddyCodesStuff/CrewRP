...
Config.Zones          = {
    ...
    Bags    = {
        Pos = {
            { x = -716.15, y = -146.05, z = 36.42 },
            { x = -164.83, y = -312.13, z = 38.73 },
            { x = 122.68, y = -229.48, z = 53.56 },
            { x = -818.84, y = -1072.72, z = 10.33 },
            { x = -1188.227, y = -764.594, z = 16.452 },
            { x = -1445.55, y = -229.49, z = 48.81 },
            { x = -1098.03, y = 2712.05, z = 18.11 },
            { x = 613.972, y = 2768.814, z = 41.208 },
            { x = 1200.21, y = 2708.75, z = 37.22 },
            { x = 1692.93, y = 4819.11, z = 41.06 },
            { x = 1.1, y = 6511.25, z = 30.88 },
            { x = 2740.57, y = 3475.23, z = 54.67 },
            { x = -820.78, y = -1078.67, z = 10.34 },
            { x = 80.59, y = -1393.89, z = 28.39 },
            { x = 420.1, y = -805.25, z = 28.50 },
            { x = 2.17, y = 6516.98, z = 30.89 },
            { x = 1195.6, y = 2705.11, z = 37.23 },
            { x = -1098.84, y = 2706.14, z = 18.12 },
        }
    },
    ...
    Glasses = {
        Pos = {
            ...
            { x = 614.28, y = 2760.38, z = 41.09 },
            { x = 1198.678, y = 2711.011, z = 37.342 },
            { x = -1195.05, y = -769.43, z = 16.32 },
