...
VALUES ('society_cardealer', 'Concessionnaire', 1)
;

INSERT INTO `addon_inventory` (`name`, `label`, `shared`)
VALUES ('society_cardealer', 'Concesionnaire', 1)
;

INSERT INTO `jobs` (`name`, `label`)
VALUES ('cardealer', 'Concessionnaire')
;

INSERT INTO `job_grades` (`job_name`, `grade`, `name`, `label`, `salary`, `skin_male`, `skin_female`)
VALUES ('cardealer', 0, 'recruit', 'Recrue', 10, '{}', '{}'),
...
(
    ...
    `owner`       varchar(30)  NOT NULL,
    `payments`    int(4)       NOT NULL DEFAULT 0,
...
VALUES ('Blade', 'blade', 15000, 'muscle'),
