...
-- TriggerEvent('esx_phone:registerNumber', 'mecano', _U('mechanic_customer'), true, true)
 TriggerEvent('esx_society:registerSociety', 'mecano', 'Mecano', 'society_mecano', 'society_mecano', 'society_mecano',
              { type = 'private' })

ESX.RegisterUsableItem('repairkit_advanced', function(source)
  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  TriggerClientEvent('esx_mechanicjob:repair_vehicle', _source)
end)

ESX.RegisterUsableItem('repairkit_basic', function(source)
  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  TriggerClientEvent('esx_mechanicjob:basic_repair', _source)
end)

ESX.RegisterUsableItem('carcleaner', function(source)
  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  TriggerClientEvent('esx_mechanicjob:carcleaner', _source)
  --xPlayer.removeInventoryItem('carcleaner', 1)
end)

RegisterNetEvent('esx_mechanicjob:pay')
AddEventHandler('esx_mechanicjob:pay', function(amount)
  local _src    = source
...
RegisterNetEvent('esx_mechanicjob:takeItem')
AddEventHandler('esx_mechanicjob:takeItem', function(item, quantity)
  local _src    = source
...
-- Sends the repair event to the net owner of a vehicle to sync
RegisterNetEvent('esx_mechanicjob:sendRepairNet')
AddEventHandler('esx_mechanicjob:sendRepairNet', function(vehicle, type, police)
  local owner = NetworkGetEntityOwner(NetworkGetEntityFromNetworkId(vehicle))
  TriggerClientEvent('esx_mechanicjob:netRepairVehicle', owner, vehicle, type, police)
end)
...
ESX.RegisterServerCallback('esx_mechanicjob:checkInventoryItem', function(source, cb, item)
  local _src    = source
  local xPlayer = ESX.GetPlayerFromId(_src)
  print(item)
