...
VALUES ('slaughterer', 'Schlachterei'),
       ('fisherman', 'Fischerei'),
       ('miner', 'Bergbau'),
...
VALUES ('lumberjack', 0, 'employee', 'Mitarbeiter', 0, '{}', '{}'),
       ...
       ('miner', 0, 'employee', 'Mitarbeiter', 0,
        ...
        '{}'),
       ('slaughterer', 0, 'employee', 'Mitarbeiter', 0,
...
VALUES ('alive_chicken', 'lebendes Huhn', 20),
