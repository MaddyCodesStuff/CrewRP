...
VALUES ('caution', 'Deposito', 0)
;

INSERT INTO `jobs` (`name`, `label`)
VALUES ('slaughterer', 'Abatedor'),
       ('fisherman', 'Pescador'),
       ('miner', 'Minerador'),
       ('lumberjack', 'Lenhador'),
       ('fueler', 'Refinador'),
...
VALUES ('lumberjack', 0, 'employee', 'Temporario', 0, '{}', '{}'),
       ...
       ('miner', 0, 'employee', 'Temporario', 0,
        ...
        '{}'),
       ('slaughterer', 0, 'employee', 'Temporario', 0,
...
VALUES ('alive_chicken', 'Frango Vivo', 20),
