...
VALUES ('lumberjack', 0, 'interim', 'Työläinen', 0, '{}', '{}'),
       ...
       ('miner', 0, 'interim', 'Työläinen', 0,
        ...
        '{}'),
       ('slaughterer', 0, 'interim', 'Työläinen', 0,
...
VALUES ('alive_chicken', 'Elävä kana', 20),
