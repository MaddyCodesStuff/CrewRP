...
Config.localWeight    = {
    ...
    WEAPON_PDCARBINE        = 15000,
    WEAPON_PDRIFLE          = 15000,
    WEAPON_PDSHOTGUN        = 15000,
    WEAPON_PDPISTOL         = 5000,
    WEAPON_PDREVOLVER       = 5000,
    WEAPON_PDSMG            = 5000,
    WEAPON_TASER2           = 5000,
    WEAPON_AIRSOFTRIFLE     = 5000,
    WEAPON_BAGUETTE         = 1000,
    WEAPON_BOLTSNIPER       = 10000,
    WEAPON_BONESAW          = 5000,
    WEAPON_BREACH           = 10000,
    WEAPON_BROOM            = 5000,
    WEAPON_CLEAVER          = 5000,
    WEAPON_CRUTCH           = 5000,
    WEAPON_FIRE_AXE         = 10000,
    WEAPON_HEAVYRIFLE       = 16000,
    WEAPON_UNICORN          = 5000,
    WEAPON_HOCKEYSTICK      = 5000,
    WEAPON_ICICLE           = 1000,
    WEAPON_KATANA           = 10000,
    WEAPON_KITCHENKNIFE     = 5000,
    WEAPON_MILITIA          = 10000,
    WEAPON_NAILBAT          = 5000,
    WEAPON_PICKAXE          = 5000,
    WEAPON_PIPE             = 5000,
    WEAPON_SCREWRDRIVER     = 1000,
    WEAPON_SHANK            = 1000,
    WEAPON_SHOVEL           = 5000,
    WEAPON_SLEDGEHAMMER     = 15000,
    WEAPON_TOILETBRUSH      = 1000,
    clothe                  = 1000,
    metal                   = 250,
    plastic                 = 250,
    gurney                  = 2500,
