...
RegisterNetEvent('esx_status:clearDrugs')
AddEventHandler('esx_status:clearDrugs', function(player)
    ...
    TriggerServerEvent('esx_status:clearDrugs', player)
end)
