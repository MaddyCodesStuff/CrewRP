...
RegisterServerEvent('esx_status:clearDrugs')
AddEventHandler('esx_status:clearDrugs', function()
    local _source = source

    TriggerClientEvent('esx_status:remove', _source, 'drug', 1000000)
    TriggerClientEvent('esx_status:remove', _source, 'poison', 1000000)
    TriggerClientEvent('esx_status:remove', _source, 'drunk', 1000000)
end)
