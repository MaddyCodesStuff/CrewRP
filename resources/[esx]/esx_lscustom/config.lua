...
Config.Zones        = {
    ls1    = {
        Pos      = { x = -359.61, y = -133.16, z = 38.01 },
        Inner    = { x = -337.3863, y = -136.9247, z = 38.5737, h = 253.51 },
        Outer    = { x = -360.9, y = -132.72, z = 38.98, h = 71.17 },
    ...
    ls2    = {
        Pos      = { x = -1144.45, y = -1989.52, z = 13.16 },
        Inner    = { x = -1155.536, y = -2007.183, z = 12.744, h = 136.75 },
        Outer    = { x = -1142.52, y = -1988.11, z = 12.45, h = 315.66 },
        Size     = { x = 3.0, y = 3.0, z = 0.2 },
        Color    = { r = 204, g = 204, b = 0 },
        Marker   = 1,
        Name     = "Los Santos Customs",
    ...
    ls3    = {
        ...
        Pos      = { x = 719.07, y = -1088.61, z = 21.733 },
        Inner    = { x = 731.8163, y = -1088.822, z = 21.733, h = 269.12 },
        Outer    = { x = 719.07, y = -1088.61, z = 21.733, h = 88.33 },
        Size     = { x = 3.0, y = 3.0, z = 0.2 },
        Color    = { r = 204, g = 204, b = 0 },
        Marker   = 1,
        Name     = "Los Santos Customs",
    ...
    ls4    = {
        Pos      = { x = 1174.81, y = 2648.11, z = 37.79 },
        Inner    = { x = 1175.04, y = 2640.216, z = 37.32177, h = 180.0 },
        Outer    = { x = 1174.98, y = 2648.51, z = 37.8, h = 359.82 },
        Size     = { x = 3.0, y = 3.0, z = 0.2 },
        Color    = { r = 204, g = 204, b = 0 },
        Marker   = 1,
        Name     = "Los Santos Customs",
    ...
    ls5    = {
        ...
        Pos      = { x = 116.48, y = 6621.06, z = 30.89 },
        Inner    = { x = 110.23, y = 6627.9, z = 31.22, h = 42.83 },
        Outer    = { x = 120.27, y = 6617.46, z = 31.27, h = 223.3 },
        Size     = { x = 3.0, y = 3.0, z = 0.2 },
        Color    = { r = 204, g = 204, b = 0 },
        Marker   = 1,
        Name     = "Los Santos Customs",
    ...
    ls6    = {
        -- Pos   = { x = 110.99, y = 6626.39, z = 30.89},
        Pos      = { x = -1550.1, y = -3181.79, z = 13.94 },
        Inner    = { x = -963.93, y = -2984.08, z = 13.95, h = 59.01 },
        Outer    = { x = -1550.1, y = -3181.79, z = 13.94, h = 147.77 },
        Size     = { x = 3.0, y = 3.0, z = 0.2 },
        Color    = { r = 204, g = 204, b = 0 },
        Marker   = 1,
        Name     = "Los Santos Customs",
    ...
    bennys = {
        Pos      = { x = -205.38, y = -1308.6, z = 29.68, h = 263.09 },
        Inner    = { x = -221.13, y = -1329.29, z = 29.89, h = 91.28 },
        Outer    = { x = -205.96, y = -1317.29, z = 29.29, h = 359.47 },
        Size     = { x = 3.0, y = 3.0, z = 0.2 },
        Color    = { r = 204, g = 204, b = 0 },
        Marker   = 1,
    ...
    marina = {
        ...
        Outer    = { x = -816.52, y = -1507.93, z = 0.00, h = 133.59 },
        Size     = { x = 5.0, y = 5.0, z = 0.2 },
        Color    = { r = 204, g = 204, b = 0 },
        Marker   = 1,
        Name     = "Marina Customs",
        Hint     = "Press ~INPUT_CONTEXT~ to enter Los Santos Customs",
        locked   = false,
        ShowBlip = true,
    },
}
...
Config.Menus = {
    ...
    modBrakes           = {
        ...
        parent  = 'upgrades',
        modType = 12,
        price   = { 0.15, 0.30, 0.90, 1.95 }
    },
    modTransmission     = {
        label   = _U('transmission'),
        parent  = 'upgrades',
        modType = 13,
        price   = { 3.01, 6.50, 12.50 }
    },
    modSuspension       = {
        label   = _U('suspension'),
        parent  = 'upgrades',
        modType = 15,
        price   = { 0.68, 1.28, 2.98, 7.82, 40.2 }
    },
    modArmor            = {
        label   = _U('armor'),
        parent  = 'upgrades',
    ...
    cosmetics           = {
        ...
        modAPlate         = 'Front Plate',
        modSpeakers       = 'Sounds',
        modTrunk          = 'Trunk',
        modHydrolic       = 'Hydrolics',
        modEngineBlock    = 'Engine Block',
        modAirFilter      = 'Air Filter',
        modStruts         = 'Struts',
        modArchCover      = 'Decklid',
        modAerials        = 'Antenna',
        modTrimB          = 'Interior 2',
        modTank           = 'Gas Tank',
        modWindows        = 'Windows',
    ...
    modFrontWheelsTypes = {
		...
		modFrontWheelsType8 = _U('supermod'),
		modFrontWheelsType9 = _U('supermod2')
    },
    modFrontWheelsType0 = {
        label     = _U('sport'),
