(function () {
    ...
    let MenuTpl = '<div id="menu_{{_namespace}}_{{_name}}" class="menu{{#align}} align-{{align}}{{/align}}">' +
                  '<div class="head"><span>{{{title}}}</span></div>' + '<div class="menu-items">' + '{{#elements}}' +
                  '<div class="menu-item {{#selected}}selected{{/selected}}">' +
                  '{{{label}}}{{#isSlider}} : &lt;{{{sliderLabel}}}&gt;{{/isSlider}}' + '</div>' + '{{/elements}}' +
                  '</div>' + '</div>' + '</div>';
                ...
                for (let i = 0; i < menuData.elements.length; i++) {
                    ...
                    switch (element.type) {
                        ...
                        case 'slider' : {
                            ...
                            element.sliderLabel = (typeof element.options == 'undefined') ? element.value :
                    ...
                    case 'TOP' : {
                        ...
                        if (typeof focused != 'undefined') {
                            ...
                            $('#menu_' + focused.namespace + '_' + focused.name)
                                .find('.menu-item.selected')[0].scrollIntoView();
