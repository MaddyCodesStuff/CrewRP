...
-- Detect if close to a repair station
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(1050)
        if IsPedSittingInAnyVehicle(GetPlayerPed(-1)) then
            for i = 1, #CivRepairStation do
                local garageCoords2 = CivRepairStation[i]
                local distance = #(GetEntityCoords(GetPlayerPed(-1)) - vector3(garageCoords2[1], garageCoords2[2], garageCoords2[3]))
...
-- Draw markers / handle key press if needed
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(1)
        if instation > 0 then
            local garageCoords2 = CivRepairStation[instation]
            DrawMarker(-27, garageCoords2[1], garageCoords2[2], garageCoords2[3], 0, 0, 0, 0, 0, 0, 5.0, 5.0, 2.0,
                   0, 157, 0, 155, 0, 0, 2, 0, 0, 0, 0)
...
Citizen.CreateThread(function()
    while true do
        ...
        if insidemarkercheck == true and stage1 == true and stage2 == false and stage3 == false and stage4 == false and stage5 == false and stage6 == false then
            Draw3DText(1153.9860839844, -781.12658691406, 57.598682403564 + 0.2,
                       tostring("~w~We are still looking over your vehicle ~o~Come back later"))
            Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564, tostring("~w~Repair Status: ~r~25%"))
            Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2,
                        tostring("~w~Checking over your vehicle.."))
        end
        ...
        if insidemarkercheck == true and stage1 == false and stage2 == true and stage3 == false and stage4 == false and stage5 == false and stage6 == false then
            ...
            Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2,
                        tostring("~w~Working on the engine.."))
        end
        ...
        if insidemarkercheck == true and stage1 == false and stage2 == false and stage3 == true and stage4 == false and stage5 == false and stage6 == false then
            ...
            Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2,
                        tostring("~w~Fixing your transmission.."))
        end
        ...
        if insidemarkercheck == true and stage1 == false and stage2 == false and stage3 == false and stage4 == true and stage5 == false and stage6 == false then
            ...
            Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2,
                        tostring("~w~Changing your vehicles oil.."))
        end
        ...
        if insidemarkercheck == true and stage1 == false and stage2 == false and stage3 == false and stage4 == false and stage5 == true and stage6 == false then
            ...
            Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2,
                        tostring("~w~Cleaning the interior of your vehicle.."))
        end
        ...
        if insidemarkercheck == true and stage1 == false and stage2 == false and stage3 == false and stage4 == false and stage5 == false and stage6 == true then
            Draw3DText(1153.9860839844, -781.12658691406, 57.598682403564 + 0.2,
                       tostring("~w~Vehicle has been detailed repaired and fixed ~g~You can now enter your vehicle"))
            Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564, tostring("~w~Repair Status: ~g~100%"))
            Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2,
                        tostring("~w~Everything is good to go!"))
        end
...
Citizen.CreateThread(function()
    while true do
        ...
        if stage6 == true then
            ...
            Draw3DText2(plyPos.x, plyPos.y, plyPos.z + 0.1,
                        tostring("~w~Press ~r~E~w~ to lock Your vehicle at the shop"))
        end
...
its optional to have SetEntityAsMissionEntity  Just uncomment the lines below to set the vehicles to not despawn.
    ...
    SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false),
                        0.0000000001) -- Sets vehicle dirt level to be 0 (This is kinda pointless unless they are super dirty ;) )
    ...
    --- Turns Engine on (Lets turn this bad boy on and see if she runs )
    ...
    --- Sets vehicle drivable (Just a pre drivable driveable to make sure its driveable ya know ;) )
    SetVehicleUndriveable(GetVehiclePedIsUsing(GetPlayerPed(-1)), false)
    --- Sets Vehicle Drivable (Now they can move the vehicle vrrrrmmm vrrrmmm )
...
AddEventHandler('Civrepair:notenoughmoney', function(moneyleft)
    ...
    TriggerEvent('chatMessage', 'CivRepair', { 255, 0, 0 },
                 "You do not have enough money you're missing ^1$" .. moneyleft .. "")
    DrawSpecialText(msg, 5000)
    Wait(5000)
end)
--[[
...
AddEventHandler('Civrepair:notenoughmoneypremium', function(moneyleft)
    --	TriggerEvent('chatMessage', 'Bilvasken', {255, 0, 0}, "Du har ikke penge nok, du mangler ^1kr" .. moneyleft .. "") -- danish
    TriggerEvent('chatMessage', 'CivRepair', { 255, 0, 0 },
                 "You do not have enough money for ^3Premium^0 you're missing ^1$" .. moneyleft .. "")
    DrawSpecialText(msg, 5000)
    Wait(5000)
end)
...
function AutoRepair()
    -- Credits qalle for assisting with this

    local elements = {
        { label = 'Fast Repair $1000', value = "repair_fast" },
        { label = 'Repair $400', value = "repair_slow" }
    }

    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'civrepair_menu',
        {
            title    = "Auto Repair Station",
            align    = 'center',
            elements = elements
        },
        function(data, menu)
...
function GetClosestVehicleToPlayer()
    ...
    local radius              = 3.0
    local rayHandle           = StartShapeTestCapsule(plyPos.x, plyPos.y, plyPos.z, plyOffset.x, plyOffset.y,
                                                      plyOffset.z, radius,
                                                      10, plyPed, 7)
