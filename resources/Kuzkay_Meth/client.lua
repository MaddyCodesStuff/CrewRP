...
AddEventHandler('esx_methcar:blowup', function(posx, posy, posz)
    ...
    local fire = StartParticleFxLoopedAtCoord("ent_ray_heli_aprtmnt_l_fire", posx, posy, posz - 0.8, 0.0, 0.0, 0.0, 0.8,
...
AddEventHandler('esx_methcar:smoke', function(posx, posy, posz, bool)
    ...
    if bool == 'a' then
        ...
        SetPtfxAssetNextCall("core")
        local smoke = StartParticleFxLoopedAtCoord("exp_grd_flare", posx, posy, posz + 1.7, 0.0, 0.0, 0.0, 2.0, false,
                                                   false, false, false)
        ...
        if started == true then
            if progress < 96 then
                ...
                if not pause and IsPedInAnyVehicle(playerPed) then
                    ...
                    Citizen.Wait(6000) -- Is this the tick timer before it runs again? Looks like it's a total of 12 seconds?
                end
                --
                --   EVENT 1
                --
                if progress > 20 and progress < 28 then
                    pause = true
                    if selection == 0 then
                ...
                print('meth production finished')
                FreezeEntityPosition(LastCar, false)
