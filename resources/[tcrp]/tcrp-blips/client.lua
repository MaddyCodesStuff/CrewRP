...
local ACTIVE = false
AddEventHandler("tcrp-blips:toggle", function(toggle)
    ACTIVE = toggle
end)
        ...
        for k, v in pairs(onRadio) do 
            ...
            if GetPlayerPed(-1) ~= ped or Debug.SeeOwnBlip then
                if job == "police" then 
                    ...
                    exports['blip_info']:SetBlipInfoImage(blip, POLICE.Config["Info.dictionary"] or Config.DefaultDictionary, POLICE.Config["Info.image"] or Config.DefaultImage)
                ...
                elseif job == "ambulance" then 
                    ...
                    exports['blip_info']:SetBlipInfoImage(blip, MEDICAL.Config["Info.dictionary"] or Config.DefaultDictionary, MEDICAL.Config["Info.image"] or Config.DefaultImage)
                ...
                elseif job == "fireman" then 
                    ...
                    exports['blip_info']:SetBlipInfoImage(blip, FIRE.Config["Info.dictionary"] or Config.DefaultDictionary, FIRE.Config["Info.image"] or Config.DefaultImage)
                ...
                elseif job == "parkranger" then 
                    ...
                    exports['blip_info']:SetBlipInfoImage(blip, PARKS.Config["Info.dictionary"] or Config.DefaultDictionary, PARKS.Config["Info.image"] or Config.DefaultImage)
                ...
                elseif job == "corrections" then 
                    ...
                    exports['blip_info']:SetBlipInfoImage(blip, CORRECTIONS.Config["Info.dictionary"] or Config.DefaultDictionary, CORRECTIONS.Config["Info.image"] or Config.DefaultImage)
