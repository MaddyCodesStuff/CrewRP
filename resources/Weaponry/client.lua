...
local scopedWeapons = {
    ...
    `WEAPON_HEAVYSNIPER_MK2`, -- WEAPON_HEAVYSNIPER MKII
...
function ManageReticle()
    ...
    if not HashInTable(hash) or not IsControlPressed(0, 25) then
...
local recoils = {
    ...
    [3249783761]  = 0.5, -- REVOLVER
    [-879347409]  = 0.65, -- REVOLVER MK2
    [4019527611]  = 0.6, -- DOUBLE BARREL SHOTGUN
