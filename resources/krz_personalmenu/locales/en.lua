Locales['en'] = {
    ...
    ['wallet_show_driver_button']      = 'Show drivers license',
    ['wallet_check_driver_button']     = 'Look at drivers license',
    ['wallet_show_firearms_button']    = 'Show gun license',
    ['wallet_check_firearms_button']   = 'Look at gun license',
    ['wallet_show_hunting_button']     = 'Show hunting license',
    ['wallet_check_hunting_button']    = 'Look at hunting license',
    ['wallet_show_pilot_button']       = 'Show pilots license',
    ['wallet_check_pilot_button']      = 'Look at pilots license',
    ...
    ['admin_goto_button']              = 'TP to Player',
    ['admin_bring_button']             = 'TP Player to me',
    ['admin_tpxyz_button']             = 'TP to Coordinates',
    ['admin_noclip_button']            = 'NoClip',
    ['admin_godmode_button']           = 'Invincible Mode',
    ['admin_ghostmode_button']         = 'Ghost Mode',
    ['admin_spawnveh_button']          = 'Spawn Vehicle',
    ['admin_repairveh_button']         = 'Repair Vehicle',
    ['admin_flipveh_button']           = 'Flip Vehicle',
    ['admin_givemoney_button']         = 'Give money ',
    ['admin_givebank_button']          = 'Give money (bank) ',
    ['admin_givedirtymoney_button']    = 'Give dirty money',
    ['admin_showxyz_button']           = 'Show / Hide Coordinates',
    ['admin_showname_button']          = 'Show / Hide Player Names',
    ['admin_tpmarker_button']          = 'TP to Marker',
    ...
    ['doyouwanna']                     = "~y~F7~w~ to accept, ~r~L~w~ to refuse (~g~",
