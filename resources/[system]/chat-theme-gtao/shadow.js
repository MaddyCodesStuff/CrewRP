(function () {
    ...
    Filters._svgDropshadowFilterBlur.setAttribute('stdDeviation', 1 * blurScale + ' ' + 1 * blurScale);
    Filters._svgDropshadowFilterOffset.setAttribute('dx', String(Math.cos(45 * Math.PI / 180) * 1 * scale));
    Filters._svgDropshadowFilterOffset.setAttribute('dy', String(Math.sin(45 * Math.PI / 180) * 1 * scale));
