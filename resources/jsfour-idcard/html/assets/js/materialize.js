...
(function (factory) {
    ...
    function find(selector, context) {
        context   = context || doc;
        var elems = classMatch.test(selector) ? context.getElementsByClassName(selector.slice(1)) :
    ...
    function matches(el, selector) {
        var m = el && (el.matches || el.webkitMatchesSelector || el.mozMatchesSelector || el.msMatchesSelector ||
                       el.oMatchesSelector);
    ...
    fn.extend({
                  ...
                  attr: function (name, value) {
                      ...
                      if (isString(name)) {
                          if (value === undefined) {
                              return this[0] ? this[0].getAttribute ? this[0].getAttribute(name) : this[0][name] :
                                  undefined;
                          }
    ...
    each(['Width', 'Height'], function (v) {
        ...
        fn['outer' + v] = function (margins) {
            return this[0]['offset' + v] + (margins ? compute(this, 'margin' + (v === 'Width' ? 'Left' : 'Top')) +
...
M.checkWithinContainer = function (container, bounding, offset) {
    ...
    if (scrolledX + bounding.width > containerRect.right - offset || scrolledX + bounding.width > window.innerWidth -
        offset) {
        edges.right = true;
    }
    ...
    if (scrolledY + bounding.height > containerRect.bottom - offset || scrolledY + bounding.height >
...
M.checkPossibleAlignments = function (el, container, bounding, offset) {
    ...
    canAlign.spaceOnBottom =
        !containerAllowsOverflow ? containerHeight - (scrolledYTopEdge + bounding.height + offset) :
...
(function (r) {
    ...
    function E(a, c) {
        if (c in a.style) {
            return getComputedStyle(a)
                       .getPropertyValue(c.replace(/([a-z])([A-Z])/g, '$1-$2').toLowerCase()) || '0';
        }
    }
    ...
    function q(a) {
        ...
        function k(a) {
            ...
            f('update');
            a >= k && (g.remaining ? (t = h, 'alternate' === g.direction && (g.reversed = !g.reversed)) :
                (g.pause(), g.completed ||
    ...
    var Dropdown = function (_Component2) {
        ...
        _createClass(Dropdown, [{
            ...
            value: function _getDropdownPosition() {
                ...
                var alignments            = M.checkPossibleAlignments(this.el, closestOverflowParent, dropdownBounds,
            ...
            value: function _placeDropdown() {
                ...
                var idealWidth              = this.options.constrainWidth ? this.el.getBoundingClientRect().width :
        ...
        _createClass(Modal, [{
            ...
            value: function _animateIn() {
                ...
                var enterAnimOptions = {
                    targets:  this.el,
                    duration: this.options.inDuration,
                    easing:   'easeOutCubic', // Handle modal onOpenEnd callback
                    complete: function () {
            ...
            value: function _animateOut() {
                ...
                var exitAnimOptions = {
                    targets:  this.el,
                    duration: this.options.outDuration,
                    easing:   'easeOutCubic', // Handle modal ready callback
                    complete: function () {
...
;(function ($, anim) {
    ...
    var Materialbox = function (_Component4) {
        ...
        function Materialbox(el, options) {
            ...
            var _this15 = _possibleConstructorReturn(this,
        ...
        _createClass(Materialbox, [{
            ...
            value: function _animateImageIn() {
                ...
                var animOptions = {
                    ...
                    left:     M.getDocumentScrollLeft() + this.windowWidth / 2 - this.placeholder.offset().left -
                              this.newWidth / 2,
                    top:      M.getDocumentScrollTop() + this.windowHeight / 2 - this.placeholder.offset().top -
                              this.newHeight / 2,
                    duration: this.options.inDuration,
                    easing:   'easeOutQuad',
                    complete: function () {
...
;(function ($) {
    ...
    var Parallax = function (_Component5) {
        ...
        function Parallax(el, options) {
            ...
            var _this20 = _possibleConstructorReturn(this,
    ...
    var Tabs = function (_Component6) {
        ...
        function Tabs(el, options) {
            ...
            var _this21 = _possibleConstructorReturn(this,
                                                     (Tabs.__proto__ || Object.getPrototypeOf(Tabs)).call(this, Tabs,
                                                                                                          el, options));
...
;(function ($, anim) {
    ...
    var Tooltip = function (_Component7) {
        ...
        function Tooltip(el, options) {
            ...
            var _this25 = _possibleConstructorReturn(this,
    ...
    var Toast = function () {
        ...
        _createClass(Toast, [{
            ...
            value: function _createToast() {
                ...
                // Set content
                if (typeof HTMLElement === 'object' ? this.message instanceof HTMLElement :
                    this.message && typeof this.message === 'object' && this.message !== null &&
                    this.message.nodeType === 1 && typeof this.message.nodeName === 'string') {
...
;(function ($, anim) {
    ...
    var Sidenav = function (_Component8) {
        ...
        function Sidenav(el, options) {
            ...
            var _this30 = _possibleConstructorReturn(this,
...
;(function ($, anim) {
    ...
    var ScrollSpy = function (_Component9) {
        ...
        function ScrollSpy(el, options) {
            ...
            var _this34 = _possibleConstructorReturn(this,
                                                     (ScrollSpy.__proto__ || Object.getPrototypeOf(ScrollSpy)).call(
                                                         this, ScrollSpy, el, options));
...
;(function ($) {
    ...
    var Autocomplete = function (_Component10) {
        ...
        function Autocomplete(el, options) {
            ...
            var _this36 = _possibleConstructorReturn(this, (Autocomplete.__proto__ ||
                                                            Object.getPrototypeOf(Autocomplete)).call(this,
                                                                                                      Autocomplete, el,
                                                                                                      options));
        ...
        _createClass(Autocomplete, [{
            ...
            value: function _highlight(string, $el) {
                ...
                $el.html('<span>' + beforeMatch + '<span class=\'highlight\'>' + matchText + '</span>' + afterMatch +
                         '</span>');
                if (img.length) {
                    $el.prepend(img);
                }
    ...
    $(document).ready(function () {
                ...
                setTimeout(function () {
                    formReset.find('select').each(function () {
                        ...
                        if (this.M_FormSelect) {
                            var reset_text                                     = $(this).find('option[selected]')
                                                                                        .text();
        ...
        document.addEventListener('blur', function (e) {
            ...
            if ($inputElement.is(input_selector)) {
                ...
                if ($inputElement[0].value.length === 0 && $inputElement[0].validity.badInput !== true &&
...
;(function ($, anim) {
    ...
    var Slider = function (_Component11) {
        ...
        function Slider(el, options) {
            ...
            var _this39 = _possibleConstructorReturn(this,
                                                     (Slider.__proto__ || Object.getPrototypeOf(Slider)).call(this,
                                                                                                              Slider,
                                                                                                              el,
                                                                                                              options));
...
;(function ($) {
    ...
    var Chips = function (_Component12) {
        ...
        function Chips(el, options) {
            ...
            var _this44 = _possibleConstructorReturn(this,
...
;(function ($) {
    ...
    var Pushpin = function (_Component13) {
        ...
        function Pushpin(el, options) {
            ...
            var _this46 = _possibleConstructorReturn(this,
...
;(function ($, anim) {
    ...
    var FloatingActionButton = function (_Component14) {
        ...
        function FloatingActionButton(el, options) {
            ...
            var _this47 = _possibleConstructorReturn(this, (FloatingActionButton.__proto__ ||
                                                            Object.getPrototypeOf(FloatingActionButton)).call(this,
        ...
        _createClass(FloatingActionButton, [{
            ...
            key:   'init',
            value: function init(els, options) {
                return _get(FloatingActionButton.__proto__ || Object.getPrototypeOf(FloatingActionButton), 'init', this)
                    .call(this, this, els, options);
            }
...
;(function ($) {
    ...
    var Datepicker = function (_Component15) {
        ...
        function Datepicker(el, options) {
            ...
            var _this52 = _possibleConstructorReturn(this,
                                                     (Datepicker.__proto__ || Object.getPrototypeOf(Datepicker)).call(
                                                         this, Datepicker, el, options));
        ...
        _createClass(Datepicker, [{
                ...
                for (var i = 0, r = 0; i < cells; i++) {
                    var day          = new Date(year, month, 1 + (i - before)),
                        ...
                        isDisabled   = opts.minDate && day < opts.minDate || opts.maxDate && day > opts.maxDate ||
                                       opts.disableWeekends && Datepicker._isWeekend(day) || opts.disableDayFn &&
            ...
            value: function renderDay(opts) {
                ...
                return '<td data-day="' + opts.day + '" class="' + arr.join(' ') + '" aria-selected="' + ariaSelected +
                       '">' + '<button class="datepicker-day-button" type="button" ' + 'data-pika-year="' + opts.year +
                       '" data-pika-month="' + opts.month + '" data-pika-day="' + opts.day + '">' + opts.day +
                       '</button>' + '</td>';
            }
        }, {
            key:   'renderRow',
            value: function renderRow(days, isRTL, isRowSelected) {
                return '<tr class="pika-row' + (isRowSelected ? ' is-selected' : '') + '">' +
            ...
            value: function renderTable(opts, data, randId) {
                return '<div class="datepicker-table-wrapper"><table cellpadding="0" cellspacing="0" class="datepicker-table" role="grid" aria-labelledby="' +
                       randId + '">' + this.renderHead(opts) + this.renderBody(data) + '</table></div>';
            }
        }, {
            key:   'renderHead',
            value: function renderHead(opts) {
                var i = void 0, arr = [];
                for (i = 0; i < 7; i++) {
                    arr.push('<th scope="col"><abbr title="' + this.renderDayName(opts, i) + '">' +
            ...
            value: function renderTitle(instance, c, year, month, refYear, randId) {
                ...
                for (arr = []; i < j && i <= opts.maxYear; i++) {
                    if (i >= opts.minYear) {
                        arr.push('<option value="' + i + '"' + (i === year ? ' selected="selected"' : '') + '>' + i +
                                 '</option>');
                    }
                }
                ...
                html += '<button class="month-prev' + (prev ? '' : ' is-disabled') + '" type="button">' + leftArrow +
                        '</button>';
                ...
                html += '<button class="month-next' + (next ? '' : ' is-disabled') + '" type="button">' + rightArrow +
                        '</button>';
                // }
            ...
            value: function draw(force) {
                ...
                for (var c = 0; c < 1; c++) {
                    this._renderDateDisplay();
                    html += this.renderTitle(this, c, this.calendars[c].year, this.calendars[c].month,
            ...
            value: function _handleCalendarClick(e) {
                ...
                if (!$target.hasClass('is-disabled')) {
                    if ($target.hasClass('datepicker-day-button') && !$target.hasClass('is-empty') &&
                        !$target.parent().hasClass('is-disabled')) {
                        this.setDate(
                            new Date(e.target.getAttribute('data-pika-year'), e.target.getAttribute('data-pika-month'),
...
;(function ($) {
    ...
    var Timepicker = function (_Component16) {
        ...
        function Timepicker(el, options) {
            ...
            var _this56 = _possibleConstructorReturn(this,
                                                     (Timepicker.__proto__ || Object.getPrototypeOf(Timepicker)).call(
                                                         this, Timepicker, el, options));
        ...
        _createClass(Timepicker, [{
            ...
            value: function _pickerSetup() {
                ...
                var $clearBtn = $(
                    ...
                    (this.options.twelveHour ? '3' : '1') + '">' + this.options.i18n.clear + '</button>')
                ...
                $('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' +
                  (this.options.twelveHour ? '3' : '1') + '">' + this.options.i18n.cancel + '</button>')
                    .appendTo(confirmationBtnsContainer).on('click', this.close.bind(this));
                $('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' +
                  (this.options.twelveHour ? '3' : '1') + '">' + this.options.i18n.done + '</button>')
            ...
            value: function _buildMinutesView() {
                ...
                for (var i = 0; i < 60; i += 5) {
                    ...
                    tick.css({
                                 left: this.options.dialRadius + Math.sin(radian) * this.options.outerRadius -
                                       this.options.tickRadius + 'px',
                                 top:  this.options.dialRadius - Math.cos(radian) * this.options.outerRadius -
                                       this.options.tickRadius + 'px'
                             });
...
;(function ($) {
    ...
    var CharacterCounter = function (_Component17) {
        ...
        function CharacterCounter(el, options) {
            ...
            var _this60 = _possibleConstructorReturn(this, (CharacterCounter.__proto__ ||
                                                            Object.getPrototypeOf(CharacterCounter)).call(this,
                                                                                                          CharacterCounter,
                                                                                                          el, options));
...
;(function ($) {
    ...
    var Carousel = function (_Component18) {
        ...
        function Carousel(el, options) {
            ...
            _this61.dim               = _this61.itemWidth * 2 + _this61.options.padding || 1; // Make sure dim is non
                                                                                              // zero for divisions.
        ...
        _createClass(Carousel, [{
            ...
            value: function _setCarouselHeight(imageOnly) {
                ...
                var firstSlide = this.$el.find('.carousel-item.active').length ?
                    this.$el.find('.carousel-item.active').first() : this.$el.find('.carousel-item').first();
            ...
            value: function _scroll(x) {
                ...
                if (!this.noWrap || this.center >= 0 && this.center < this.count) {
                    ...
                    var transformString = alignment + ' translateX(' + -delta / 2 + 'px)' + ' translateX(' + dir *
                                          this.options.shift * tween * i + 'px)' + ' translateZ(' + this.options.dist *
                                          tween + 'px)';
                ...
                for (i = 1; i <= half; ++i) {
                    ...
                    if (!this.noWrap || this.center + i < this.count) {
                        ...
                        var _transformString = alignment + ' translateX(' +
                                               (this.options.shift + (this.dim * i - delta) / 2) + 'px)' +
                ...
                if (!this.noWrap || this.center >= 0 && this.center < this.count) {
                    el                    = this.images[this._wrap(this.center)];
                    var _transformString3 = alignment + ' translateX(' + -delta / 2 + 'px)' + ' translateX(' + dir *
                                            this.options.shift * tween + 'px)' + ' translateZ(' + this.options.dist *
                                            tween + 'px)';
...
;(function ($) {
    ...
    var TapTarget = function (_Component19) {
        ...
        function TapTarget(el, options) {
            ...
            var _this66 = _possibleConstructorReturn(this,
                                                     (TapTarget.__proto__ || Object.getPrototypeOf(TapTarget)).call(
                                                         this, TapTarget, el, options));
        ...
        _createClass(TapTarget, [{
            ...
            value: function _calculatePositioning() {
                ...
                var originTop    = isFixed ? this.$origin.offset().top - M.getDocumentScrollTop() :
                    this.$origin.offset().top;
                var originLeft   = isFixed ? this.$origin.offset().left - M.getDocumentScrollLeft() :
        ...
        _createClass(FormSelect, [{
                    ...
                    dropdownOptions.onOpenEnd = function (el) {
                        ...
                        if (_this70.dropdown.isScrollable && selectedOption.length) {
                            var scrollOffset = selectedOption[0].getBoundingClientRect().top -
                                               _this70.dropdownOptions.getBoundingClientRect().top; // scroll
                                                                                                    // to
                                                                                                    // selected
                                                                                                    // option
            ...
            value: function _appendOptionWithIcon(select, option, type) {
                ...
                var multipleCheckbox = this.isMultiple ?
                    '<label><input type="checkbox"' + disabledClass + '"/><span>' + option.innerHTML +
                    '</span></label>' : option.innerHTML;
                var liEl             = $('<li></li>');
...
;(function ($, anim) {
    ...
    var Range = function (_Component21) {
        ...
        function Range(el, options) {
            ...
            var _this71 = _possibleConstructorReturn(this,
