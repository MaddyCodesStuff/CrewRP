(function(t) {
    function e(e) {
        for (var i, n, a = e[0], l = e[1], c = e[2], d = 0, _ = []; d < a.length; d++) n = a[d], Object.prototype.hasOwnProperty.call(o, n) && o[n] && _.push(o[n][0]), o[n] = 0;
    ...
    function s() {
        for (var t, e = 0; e < r.length; e++) {
            for (var s = r[e], i = !0, a = 1; a < s.length; a++) {
                var l = s[a];
                0 !== o[l] && (i = !1)
            }
    ...
    "56d7": function(t, e, s) {
        ...
        var i = s("2b0e"),
            o = function() {
                ...
                return t.NuiOpen ? s("div", {
                ...
                }, [t._v(t._s(t.Texts_Nui.titulo))]), s("p", {
                    attrs: {
                        id: "instruction"
                    }
                    ...
                    }, [t._v(t._s(t.Texts_Nui.SimboloDinheiro) + t._s(e.price))]), s("span", {
                    ...
                    }, [t._v(t._s(t.Texts_Nui.QtdTattoos) + " " + t._s(e.qty))]), 1 == e.acquired ? s("span", {
                    ...
                    }, [t._v(t._s(t.Texts_Nui.TattoosAdquirida))]) : 2 == e.acquired ? s("span", {
                        staticClass: "dlc_acquired",
                        staticStyle: {
                            "margin-left": "0.5vh",
                            "font-size": "1.5vh",
                    ...
                    }, [t._v(t._s(t.Texts_Nui.TattoosRemovida))]) : t._e(), e.has ? s("span", {
                        staticClass: "dlc_has",
                        staticStyle: {
                            "margin-left": "0.5vh",
                            "font-size": "1.5vh",
                    ...
                    }, [t._v(t._s(t.Texts_Nui.JaPossuiTattoo))]) : t._e(), s("input", {
                        directives: [{
                            name: "model",
                            rawName: "v-model",
                            value: e.current,
            ...
            n = (s("d3b7"), {
                ...
                methods: {
                    receiveLua: function(t) {
                        if (t && t.data) {
                            var e = t.data;
                            if ("Keys" == e.ui ? this.Pressed_Key(e.mover) : "Interface" == e.ui && (this.NuiOpen = e.NuiOpen, e.NuiOpen && (this.list = e.list, this.position_nui = "transform: scale(" + e.position_nui + ");", this.Texts_Nui = e.Texts_Nui, this.text_button_remove_tattoos = this.Texts_Nui.BotaoRemoverTattoo)), "Info" == e.ui)
                    ...
                    Pressed_Key: function(t) {
                        ...
                        }), this.text_button_remove_tattoos = this.Texts_Nui.BotaoTattooRemovida, this.text_button_remove_tattoos_style = "border: 0.2vh solid rgba(0, 255, 0, 0.3); color: green;", setTimeout(function() {
                            this.text_button_remove_tattoos = this.Texts_Nui.BotaoRemoverTattoo, this.text_button_remove_tattoos_style = "border: 0.2vh solid rgba(255, 0, 0, 0.3); color: red;"
                        }.bind(this), 2500)))
                    }
                },
                created: function() {
            ...
            a = n,
            l = (s("034f"), s("2877")),
            c = Object(l["a"])(a, o, r, !1, null, null, null),
            u = c.exports;
