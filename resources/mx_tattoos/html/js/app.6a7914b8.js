(function(t) {
    function e(e) {
        for (var i, n, l = e[0], a = e[1], c = e[2], d = 0, h = []; d < l.length; d++) n = l[d], Object.prototype.hasOwnProperty.call(o, n) && o[n] && h.push(o[n][0]), o[n] = 0;
            ...
            n = (s("d3b7"), {
                ...
                methods: {
                    ...
                    Pressed_Key: function(t) {
                        var e = !1;
                        "Up" == t ? this.selected < 0 ? this.selected = this.list.length - 1 : this.selected-- : "Down" == t ? this.selected >= this.list.length - 1 ? this.selected = -1 : this.selected++ : "Right" == t && this.selected >= 0 ? (e = !0, this.list[this.selected].current >= this.list[this.selected].qty ? this.list[this.selected].current = 1 : this.list[this.selected].current++) : "Left" == t && this.selected >= 0 ? (e = !0, this.list[this.selected].current <= 1 ? this.list[this.selected].current = this.list[this.selected].qty : this.list[this.selected].current--) : "Enter" != t && "Delete" != t || (e = !0), e && (this.selected >= 0 ? (this.scrollToClass(this.list[this.selected].title + this.list[this.selected].dlc), console.log(this.list[this.selected].title + this.list[this.selected].dlc), fetch("https://".concat(this.NameResource, "/UpdateTattoo"), {
                            method: "POST",
                            body: JSON.stringify({
                                mx: {
                                    key: t,
