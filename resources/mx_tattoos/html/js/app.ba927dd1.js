            ...
            n = (s("d3b7"), {
                ...
                methods: {
                    ...
                    Pressed_Key: function(t) {
                        ...
                        }), this.text_button_remove_tattoos = this.Texts_Nui.BotaoRemoverTattoo, this.text_button_remove_tattoos_style = "border: 0.2vh solid rgba(0, 255, 0, 0.3); color: green;", setTimeout(function() {
                            this.text_button_remove_tattoos = this.Texts_Nui.BotaoTattooRemovida, this.text_button_remove_tattoos_style = "border: 0.2vh solid rgba(255, 0, 0, 0.3); color: red;"
                        }.bind(this), 2500)))
                    }
                },
                created: function() {
