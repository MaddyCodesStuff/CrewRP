    ...
    "56d7": function(t, e, s) {
        ...
        var i = s("2b0e"),
            o = function() {
                ...
                }, [t._v("aaa" + t._s(t.Texts_Nui.Title))]), s("p", {
                    attrs: {
                        id: "instruction"
                    }
            ...
            n = (s("d3b7"), {
                ...
                methods: {
                    receiveLua: function(t) {
                        if (t && t.data) {
                            var e = t.data;
                            if ("Keys" == e.ui ? this.Pressed_Key(e.mover) : "Interface" == e.ui && (this.NuiOpen = e.NuiOpen, e.NuiOpen && (this.list = e.list, this.position_nui = "transform: scale(" + e.position_nui + ");", this.Texts_Nui = e.Texts_Nui, this.text_button_remove_tattoos = this.Texts_Nui.ButtonRemoveTattoo)), "Info" == e.ui)
