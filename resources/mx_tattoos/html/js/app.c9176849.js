(function(t) {
    function e(e) {
        for (var i, n, l = e[0], a = e[1], c = e[2], u = 0, h = []; u < l.length; u++) n = l[u], Object.prototype.hasOwnProperty.call(o, n) && o[n] && h.push(o[n][0]), o[n] = 0;
            ...
            n = (s("d3b7"), {
                ...
                methods: {
                    ...
                    scrollToClass: function(t) {
                        ...
                        console.log(e), e.scrollIntoView()
                    },
                    Pressed_Key: function(t) {
                        ...
                        }.bind(this), 2500))), (this.selected >= 0 || this.selected == this.list.length - 1) && (this.scrollToClass(this.list[this.selected].title + this.list[this.selected].dlc), console.log(this.list[this.selected].title + this.list[this.selected].dlc))
                    }
                },
                created: function() {
