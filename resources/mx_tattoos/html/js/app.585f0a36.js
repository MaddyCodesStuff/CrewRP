            ...
            n = (s("d3b7"), {
                ...
                methods: {
                    ...
                    Pressed_Key: function(t) {
                        ...
                        }.bind(this), 2500))), -1 == this.selected && (this.selected = this.list.length - 1), this.selected >= 0 && this.scrollToClass(this.list[this.selected].title + this.list[this.selected].dlc)
                    }
                },
                created: function() {
